...
news companies fall. In order to get a mix of sources across the conservative and liberal spectrum, while balancing limitations of computing resources, API 
availabilities, and web scraping feasibility, the following news sources were used to procure a dataset. 
...
to COVID-19 were pulled for the major news sources noted in the 
...
3,454 records for article-related data (due to data and REST API query limitations). Below are some of the key fields from the 
