...
![Words Per Article](../figures/top_words_with_sentiment.png)
...
![Average Sentiment by Week](../figures/word_avg_sentiment_by_week_afinn.png)

Using the TF-IDF methodology, some interesting words shows up at the top of each 
news source. For example, romance was the top word in BBC articles. There were 
3 BBC articles about online dating during the pandemic. Example article: 
https://www.bbc.com/news/technology-55997611

*TF-IDF: https://www.tidytextmining.com/tfidf.html*

![Average Sentiment by Week](../figures/word_tfidf_top_words.png)
