...
which the news sources might be differentiated. The three dimensions modeled were: topic content, sentiment
based on key words, and vocabulary used among conservative and liberal sources. 
...
- Second paper by Green et al[9] demonstrated that absolute difference in the proportion of words used by political party using Tweet data from January to March 2020.

-	Final research by Schaeffer[10] also shows the difference in views on various topic based on their political stands from January and Feb 2021.
