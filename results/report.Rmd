...
explored. Of the lexicons available in ```tidytext::get_sentiments()``` the most informative one for this analysis was AFFIN lexicon. This provided a range of sentiments from negative to positive on a scale from -5 (most negative) to 5 (most positive). It also allows for more streamlined sentiment analysis, such as finding average sentiment. Key visualizations of the data are illustrated below.
